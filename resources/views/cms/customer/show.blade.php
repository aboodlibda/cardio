...
@section('title',trans('dashboard_trans.Customer Details'))
@section('style')
...
@section('content')
    ...
    <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-10 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
        <!--begin::Heading-->
        <h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">{{trans('dashboard_trans.Customer Details')}}</h1>
        <!--end::Heading-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-dot fw-semibold fs-base my-1">
            ...
            <li class="breadcrumb-item text-dark">{{trans('dashboard_trans.Customer Details')}}</li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
    <!--end::Page title=-->
            ...
            <div class="d-flex flex-column flex-xl-row">
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body pt-15">
                            ...
                            <div class="d-flex flex-stack fs-4 py-3">
                                <div class="fw-bold rotate collapsible" data-bs-toggle="collapse" href="#kt_customer_view_details" role="button" aria-expanded="false" aria-controls="kt_customer_view_details">{{trans('dashboard_trans.Details')}}
                                    <span class="ms-2 rotate-180">
													<i class="ki-duotone ki-down fs-3"></i>
												</span></div>
                                <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit customer details">
													<a href="#" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_update_customer">{{trans('dashboard_trans.Edit')}}</a>
												</span>
                            </div>
                            <!--end::Details toggle-->
                ...
                <div class="flex-lg-row-fluid ms-lg-15">
                    ...
                    <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#kt_customer_view_overview_tab">{{trans('dashboard_trans.Overview')}}</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_customer_view_overview_events_and_logs_tab">{{trans('dashboard_trans.Events & Logs')}}</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item">
                            <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab" href="#kt_customer_view_overview_statements">{{trans('dashboard_trans.Statements')}}</a>
                        </li>
                        <!--end:::Tab item-->
                        <!--begin:::Tab item-->
                        <li class="nav-item ms-auto">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold py-4 w-250px fs-6" data-kt-menu="true">
                                ...
                                <div class="menu-item px-5">
                                    <div class="menu-content text-muted pb-2 px-5 fs-7 text-uppercase">{{trans('dashboard_trans.Payments')}}</div>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <a href="#" class="menu-link px-5">{{trans('dashboard_trans.Create invoice')}}</a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <div class="menu-content text-muted pb-2 px-5 fs-7 text-uppercase">{{trans('dashboard_trans.Account')}}</div>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <a href="#" class="menu-link px-5">{{trans('dashboard_trans.Reports')}}</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-5">
                                    <a href="#" class="menu-link text-danger px-5">{{trans('dashboard_trans.Delete customer')}}</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
                            ...
                            <div class="card pt-4 mb-6 mb-xl-9">
                                ...
                                <div class="card-body pt-0 pb-5">
                                    ...
                                    <table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#" class="text-gray-600 text-hover-primary mb-1">2364-7784</a>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#" class="text-gray-600 text-hover-primary mb-1">3977-7227</a>
                                            </td>
                                            <td>
                                                <span class="badge badge-light-success">Successful</span>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#" class="text-gray-600 text-hover-primary mb-1">1014-7010</a>
                                            </td>
                                            <td>
                                                <span class="badge badge-light-success">Successful</span>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#" class="text-gray-600 text-hover-primary mb-1">4003-2643</a>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#" class="text-gray-600 text-hover-primary mb-1">6706-5198</a>
                                            </td>
                                            <td>
                                                <span class="badge badge-light-success">Successful</span>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#" class="text-gray-600 text-hover-primary mb-1">4643-2715</a>
                                            </td>
                                            <td>
                                                <span class="badge badge-light-success">Successful</span>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#" class="text-gray-600 text-hover-primary mb-1">5068-4567</a>
                                            </td>
                                            <td>
                                                <span class="badge badge-light-success">Successful</span>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#" class="text-gray-600 text-hover-primary mb-1">7587-5786</a>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#" class="text-gray-600 text-hover-primary mb-1">3981-7993</a>
                                            </td>
                                            <td>
                                                <span class="badge badge-light-warning">Pending</span>
                                            </td>
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table table-flush fw-semibold gy-1">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-gray-800">**** 2230</td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <div class="d-flex flex-wrap py-5">
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table table-flush fw-semibold gy-1">
                                                        ...
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Number</td>
                                                            <td class="text-gray-800">**** 8456</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Expires</td>
                                            ...
                                            <div class="d-flex flex-wrap py-5">
                                                ...
                                                <div class="flex-equal me-5">
                                                    <table class="table table-flush fw-semibold gy-1">
                                                        ...
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Number</td>
                                                            <td class="text-gray-800">**** 6948</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="text-muted min-w-125px w-125px">Expires</td>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_customers_logs">
                                            ...
                                            <tr>
                                                ...
                                                <td>POST /v1/invoices/in_3993_1904/payment</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>POST /v1/invoices/in_3918_1101/payment</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>POST /v1/invoices/in_4548_8938/payment</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>POST /v1/customer/c_64b77cc0c334c/not_found</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>POST /v1/invoices/in_9944_7716/payment</td>
                                                <td class="pe-0 text-end min-w-200px">22 Sep 2023, 2:40 pm</td>
                                            </tr>
                                            <tr>
                                                <td class="min-w-70px">
                                                    <div class="badge badge-light-danger">500 ERR</div>
                                                </td>
                                                <td>POST /v1/invoice/in_1167_8708/invalid</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>POST /v1/invoices/in_6009_8487/payment</td>
