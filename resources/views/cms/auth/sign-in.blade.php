            ...
            <div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
                ...
                <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"  action="{{route('login')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3 mb-9">
                                <div class="text-center align-items-center">
                                    ...
                                    <!--begin::Symbol-->
                                    <a href="#" class="symbol symbol-circle symbol-50px w-50px bg-light me-3">
                                        <img alt="Logo" src="{{trans('assets/media/svg/brand-logos/facebook-3.svg')}}" class="p-4">
                                    </a>
                                    <!--end::Symbol-->
                            ...
                            <div class="separator separator-content my-14">
                                <span class="w-125px text-gray-500 fw-semibold fs-7">{{trans('dashboard_trans.Or with email')}}</span>
                            </div>
                            <!--end::Separator-->
                            <!--begin::Input group=-->
                            ...
                            <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                                <div></div>
                                <!--begin::Link-->
                                <a href="#" class="link-primary">{{trans('dashboard_trans.Forgot Password')}} ?</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Wrapper-->
                            <!--begin::Submit button-->
                            ...
                            <!--end::Submit button-->
                            <!--begin::Sign up-->
                            <div class="text-gray-500 text-center fw-semibold fs-6">{{trans('dashboard_trans.Not a Member yet')}}?
                    ...
                    <div class="m-0">
                        ...
                        @else
                            <button class="btn btn-flex btn-link rotate" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" data-kt-menu-offset="0px, 0px">
                                <img data-kt-element="current-lang-flag" class="w-25px h-25px rounded-circle me-3" src="{{asset('assets/media/flags/saudi-arabia.svg')}}" alt="" />
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-4" data-kt-menu="true" id="kt_auth_lang_menu">
                            ...
                            @foreach(LaravelLocalization::getSupportedLocales()  as $localeCode => $properties)
                                <div class="menu-item px-3">
                                    <a href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" hreflang="{{ $localeCode }}" class="menu-link d-flex px-5" data-kt-lang="English">
