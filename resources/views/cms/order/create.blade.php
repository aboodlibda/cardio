...
@section('title',trans('dashboard_trans.Add Order'))
@section('style')
    @if(App::getLocale()=='ar')
...
@section('content')
    ...
    <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-10 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
        <!--begin::Heading-->
        <h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">{{trans('dashboard_trans.Add Order')}}</h1>
        <!--end::Heading-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-dot fw-semibold fs-base my-1">
            ...
            <li class="breadcrumb-item text-dark">{{trans('dashboard_trans.Add Order')}}</li>
        </ul>
        <!--end::Breadcrumb-->
    </div>
    <!--end::Page title=-->
            ...
            <form id="kt_ecommerce_edit_order_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="../../demo3/dist/apps/ecommerce/sales/listing.html">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-header">
                            <div class="card-title">
                                <h2>{{trans('dashboard_trans.Order Details')}}</h2>
                            </div>
                        </div>
                        <!--end::Card header-->
                        <!--begin::Card body-->
                        <div class="card-body pt-0">
                            <div class="d-flex flex-column gap-10">
                                ...
                                <div class="fv-row">
                                    <!--begin::Label-->
                                    <label class="form-label">{{trans('dashboard_trans.Order ID')}}</label>
                                    <!--end::Label-->
                                    <!--begin::Auto-generated ID-->
                                    <div class="fw-bold fs-3">#13946</div>
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="fv-row">
                                    <!--begin::Label-->
                                    <label class="required form-label">{{trans('dashboard_trans.Payment Method')}}</label>
                                    <!--end::Label-->
                                    <!--begin::Select2-->
                                    <select class="form-select mb-2"  data-hide-search="true" data-placeholder="{{trans('dashboard_trans.Select an option')}}" name="payment_method" id="kt_ecommerce_edit_order_payment">
                                ...
                                <div class="fv-row">
                                    <!--begin::Label-->
                                    <label class="required form-label">{{trans('dashboard_trans.Shipping Method')}}</label>
                                    <!--end::Label-->
                                    <!--begin::Select2-->
                                    <select class="form-select mb-2"  data-hide-search="true" data-placeholder="{{trans('dashboard_trans.Select an option')}}" name="shipping_method" id="kt_ecommerce_edit_order_shipping">
                                ...
                                <div class="fv-row">
                                    <!--begin::Label-->
                                    <label class="required form-label">{{trans('dashboard_trans.Order Date')}}</label>
                                    <!--end::Label-->
                                    <!--begin::Editor-->
                                    <input id="kt_ecommerce_edit_order_date" name="order_date" placeholder="{{trans('dashboard_trans.Select a date')}}" class="form-control mb-2" value="" />
                                    <!--end::Editor-->
                                    <!--begin::Description-->
                                    <div class="text-muted fs-7">{{trans('dashboard_trans.Set the date of the order to process')}}.</div>
                                    <!--end::Description-->
                                </div>
                                <!--end::Input group-->
                            </div>
                ...
                <div class="d-flex flex-column flex-lg-row-fluid gap-7 gap-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-header">
                            <div class="card-title">
                                <h2>{{trans('dashboard_trans.Select Products')}}</h2>
                            </div>
                        </div>
                        <!--end::Card header-->
                        <!--begin::Card body-->
                        <div class="card-body pt-0">
                            <div class="d-flex flex-column gap-10">
                                ...
                                <div>
                                    <!--begin::Label-->
                                    <label class="form-label">{{trans('dashboard_trans.Add products to this order')}}</label>
                                    <!--end::Label-->
                                    ...
                                    <div class="row row-cols-1 row-cols-xl-3 row-cols-md-2 border border-dashed rounded pt-3 pb-1 px-2 mb-5 mh-300px overflow-scroll" id="kt_ecommerce_edit_order_selected_products">
                                        <!--begin::Empty message-->
                                        <span class="w-100 text-muted">{{trans('dashboard_trans.Choose one or more products from the list below by ticking the checkbox')}}.</span>
                                        <!--end::Empty message-->
                                    </div>
                                    <!--begin::Selected products-->
                                    <!--begin::Total price-->
                                    <div class="fw-bold fs-4">{{trans('dashboard_trans.Total Cost')}}: $
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_edit_order_product_table">
                                    ...
                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-100px text-end pe-5">{{trans('dashboard_trans.Qty Remaining')}}</th>
                                    </tr>
                                    </thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_1">
                                                ...
                                                <div class="ms-5">
                                                    <!--begin::Title-->
                                                    <a href="../../demo3/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Product 1</a>
                                                    <!--end::Title-->
                                                    <!--begin::Price-->
                                                    <div class="fw-semibold fs-7">{{trans('dashboard_trans.Price')}}: $
                                                        <span data-kt-ecommerce-edit-order-filter="price">274.00</span></div>
                                                    <!--end::Price-->
                                                    <!--begin::SKU-->
                                                    <div class="text-muted fs-7">{{trans('dashboard_trans.SKU')}}: 01405004</div>
                                                    <!--end::SKU-->
                                                </div>
                                            </div>
                                        </td>
                    ...
                    <!--end::Order details-->
                    <!--begin::Order details-->
                    <div class="card card-flush py-4" hidden="">
                        <!--begin::Card header-->
                        <div class="card-header">
                            <div class="card-title">
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="{{ route('orders.index') }}" id="kt_ecommerce_edit_order_cancel" class="btn btn-light me-5">{{trans('dashboard_trans.Cancel')}}</a>
                        <!--end::Button-->
                        <!--begin::Button-->
                        <button type="submit" id="kt_ecommerce_edit_order_submit" class="btn btn-primary">
                            <span class="indicator-label">{{trans('dashboard_trans.Cancel')}}</span>
