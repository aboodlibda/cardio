...
@section('title',trans('dashboard_trans.All Coupons'))
@section('style')
    @if(App::getLocale()=='ar')
...
@section('content')
    ...
    <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-2 pb-10 pb-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
        <!--begin::Heading-->
        <h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">{{trans('dashboard_trans.Coupons')}}</h1>
        <!--end::Heading-->
        <!--begin::Breadcrumb-->
        <ul class="breadcrumb breadcrumb-dot fw-semibold fs-base my-1">
            ...
            <li class="breadcrumb-item text-dark">{{trans('dashboard_trans.All Coupons')}}</li>
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                        ...
                        <!--begin::Add product-->
                        <a href="{{route('coupons.create')}}" class="btn btn-primary">{{trans('dashboard_trans.Add Coupon')}}</a>
                        <!--end::Add product-->
                    </div>
                    <!--end::Card toolbar-->
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="ms-5">
                                        <!--begin::Title-->
                                        <a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-coupons-filter="coupon_name">{{$coupon->code}}</a>
                                        <!--end::Title-->
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="text-end pe-0">{{$coupon->start_date}}</td>
                            <td class="text-end pe-0">
                                <!--begin::Badges-->
